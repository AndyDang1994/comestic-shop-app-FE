    ...
    return (
        <div className="container">
            <div className="row d-flex align-items-center" >
                <div  role="navigation" className=" navbar-expand-lg">
                    <div id="navigation" className="navbar-collapse collapse">
                        <ul className="main-nav nav nav-tabs">
                            ...
                            <li className="nav-item"><a href="#">Home <b className="caret"></b></a></li>
                            <li className="nav-item"><a href="#">Blog <b className="caret"></b></a></li>
                            <li className="nav-item"><a href="#">About <b className="caret"></b></a></li>
